...
const Gravity = () => {
  useEffect(() => {
    ...
    tl.from(
      '.earth-ball, .venus-ball',
      0.2,
      { autoAlpha: 0, ease: Linear.easeNone },
      0,
    );
    tl.from('.earth-ball', 3, { y: -170, ease: Bounce.easeOut }, '0.2');
    tl.from('.venus-ball', 3.3, { y: -170, ease: Bounce.easeOut }, '0.2');
    tl.to(
      '.earth-ball, .venus-ball',
      0.6,
      { autoAlpha: 0, ease: Linear.easeNone },
  ...
  return (
    <section className="gravity">
      <h3>Gravity</h3>
      <p>
        On mars, you'd experience <span>90% less gravity</span> than you're used
        to on Earth
      </p>
      <div className="gravity-group">
        ...
        <div className="venus-gravity">
          <div className="ball venus-ball"></div>
        </div>
      </div>
    </section>
  );
