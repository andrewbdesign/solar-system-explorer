  ...
  return (
    <section className="distance">
      ...
      <div className="container">
        <div className="distance__container jupiter__distance">
          <div className="jupiter-distance-container">
            <img
              className="jupiter-distance-planet"
              src={Jupiter}
              alt="jupiter"
            />
